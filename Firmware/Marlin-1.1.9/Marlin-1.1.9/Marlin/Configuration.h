...
#define DELTA
  ...
  #define DELTA_SEGMENTS_PER_SECOND 100 //80 Original
  ...
  // NOTE NB all values for DELTA_* values MUST be floating point, so always have a decimal point in them
    ...
    #define DELTA_CALIBRATION_DEFAULT_POINTS 7 //4 Original
  #endif
...
#define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_POINT { 0, 0, DELTA_HEIGHT - 20 } //{ 0, 0, 20 } Original
