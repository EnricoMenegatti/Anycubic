/**
 * Marlin 3D Printer Firmware 1.1.8 para Anycubic Version Flsun Autocalibrate
...
#define STRING_CONFIG_H_AUTHOR "(TSU, Anycubic Kossel Plus)" // Who made the changes.
...
#define DELTA
  ...
  #define DELTA_SEGMENTS_PER_SECOND 100 //Originalmente Flsun marca 200 y Anycubic 100
  ...
  // NOTE NB all values for DELTA_* values MUST be floating point, so always have a decimal point in them
    ...
    #define DELTA_CALIBRATION_DEFAULT_POINTS 4 // Originalmente el firmware Flsun marca 4 puntos
    ...
    // Set the radius for the calibration probe points - max 0.869 * DELTA_PRINTABLE_RADIUS for non-eccentric probes
    #define DELTA_CALIBRATION_RADIUS ((DELTA_PRINTABLE_RADIUS) * 0.869) // mm Se impostato uguale a delta_printable_radius potrebbe dar problemi
    // Set the steprate for papertest probing
    #define PROBE_MANUALLY_STEP 0.025
  #endif

  // Print surface diameter/2 minus unreachable space (avoid collisions with vertical towers).
  #define DELTA_PRINTABLE_RADIUS 116.0 // mm Valore di default Anycubic Delta Plus

  // Center-to-center distance of the holes in the diagonal push rods.
  #define DELTA_DIAGONAL_ROD 271.5 // mm Valore di default Anycubic Delta Plus, da cambiare con il vostro reale

  // height from z=0 to home position
  #define DELTA_HEIGHT 300.33 // Valore errato di proposito, si modifica alla prima autocalibrazione

  #define DELTA_ENDSTOP_ADJ { 0.0, 0.0, 0.0 } // get these from auto calibrate

  // Horizontal distance bridged by diagonal push rods when effector is centered.
  #define DELTA_RADIUS 134.4 //mm Valore di default Anycubic Delta Plus, si modifica alla prima autocalibrazione
 ...
 */
#define DEFAULT_ACCELERATION          2000    // X, Y, Z and E acceleration for printing moves - Original Flsun 3000
#define DEFAULT_RETRACT_ACCELERATION  2000    // E acceleration for retracts - Original Flsun 3000
#define DEFAULT_TRAVEL_ACCELERATION   2000    // X, Y, Z acceleration for travel (non printing) moves - Original Flsun 3000
...
#define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_POINT { 0, 0, (DELTA_HEIGHT - 20) } //X, Y, Z
...
//#define RGBW_LED
  ...
  #define RGB_LED_R_PIN -1 //34
  #define RGB_LED_G_PIN -1 //43
  #define RGB_LED_B_PIN -1 //35
  #define RGB_LED_W_PIN 34 //-1
#endif
